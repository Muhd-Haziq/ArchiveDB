...
public class CharaRatesGridAdapter extends BaseAdapter {
    private ArrayList<Character> characters;
    private Context context;
    private LayoutInflater inflater;
    private Boolean langBool;

    public CharaRatesGridAdapter(Context context, ArrayList<Character> characters, Boolean langBool){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            gridView = inflater.inflate(R.layout.rates_character_grid_row, null);
        ...
        Glide.with(gridView).load(currentChar.getShared_imageThumbnail()).into(imgViewIcon);
